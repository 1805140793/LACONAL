        ...
        <div class="animate form login_form">
          <section class=" container login_content">
            <form>
              ...
              <div>
                <input type="text" class="form-control" placeholder="Usuario" value="usuario" required="" />
              </div>
              <div>
              ...
              <div class="separator">
                  <a href="#signup" class="to_register"> Nueva Cuenta </a>
                </p>
                ...
                <div>
                  <h1><i class="fa fa-stethoscope"></i> Laboratorio</h1>
